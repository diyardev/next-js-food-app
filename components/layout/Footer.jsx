...
const Footer = () => {
  return (
    <footer className="dark bg-content1">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com/" className="flex items-center">
              <span className="self-center font-dancing text-4xl font-semibold whitespace-nowrap text-white">
                Diyar
              </span>
            </a>
          </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center text-gray-400">
            © 2023 {""}
            <Link href="https://flowbite.com/" color="warning">
              Diyar Akengin
            </Link>
            . All Rights Reserved.
          </span>
